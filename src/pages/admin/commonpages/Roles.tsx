...
import { Search, Plus, Edit, Trash2, Eye, Filter, Shield, Users } from 'lucide-react';
import { Role, Company, Branch } from '../../types';
...
const Roles: React.FC = () => {
  ...
  const [roles, setRoles] = useState<Role[]>([
    {
      ...
      branchId: '1',
      permissions: [
        { id: 'employee_create', name: 'employee create', module: 'employee', action: 'create', enabled: true },
        { id: 'employee_read', name: 'employee read', module: 'employee', action: 'read', enabled: true },
        { id: 'employee_update', name: 'employee update', module: 'employee', action: 'update', enabled: true },
        { id: 'attendance_read', name: 'attendance read', module: 'attendance', action: 'read', enabled: true },
      ],
      isActive: true,
      createdAt: '2024-01-01'
    },
    {
      ...
      companyId: '1',
      permissions: [
        { id: 'department_read', name: 'department read', module: 'department', action: 'read', enabled: true },
        { id: 'department_update', name: 'department update', module: 'department', action: 'update', enabled: true },
        { id: 'employee_read', name: 'employee read', module: 'employee', action: 'read', enabled: true },
      ],
      isActive: true,
  ...
  const filteredRoles = roles.filter(role => {
    ...
    const matchesCompany = filterCompany === 'all' || role.companyId === filterCompany;
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-800">
                {Math.round(roles.reduce((acc, r) => acc + r.permissions.length, 0) / roles.length || 0)}
              </p>
            </div>
          </div>
        </div>
